...
class Config(Config):
    TG_BOT_TOKEN= "1640796806:AAEVKLVqOVK98wsnUT440SoEFXtsWtyjohQ" #imp
    APP_ID = 2180427 #imp
    API_HASH = "b52730e42aabdb05615832d48c702ce6" #imp
    AUTH_CHANNEL = [-1001435264443, 201839212] #imp replace your_id with your id from telegram or delete
